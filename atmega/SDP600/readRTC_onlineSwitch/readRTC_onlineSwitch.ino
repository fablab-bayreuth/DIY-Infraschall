/*******************************************************
   ...
   You need a board with RTC-crystal. Will not work for normal arduino boards 
   
   Wiring Sensor (bottom view):
   SDA (A4) - GND - 3.3V - SCL (A5)

   The Sketch starts with a resolution of 14bit and a frequency of 51.8481Hz
   you can change the resolution on the fly by sending '2' to '5'
   Normally this is done by the esp8266
